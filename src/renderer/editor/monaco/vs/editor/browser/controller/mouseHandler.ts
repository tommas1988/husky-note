...
import { MouseTarget, MouseTargetFactory, IViewZoneData, HitTestContext } from './mouseTarget';
...
import { EditorMouseEventFactory, GlobalEditorMouseMoveMonitor, EditorMouseEvent, createEditorPagePosition, ClientCoordinates } from '../editorDom';
