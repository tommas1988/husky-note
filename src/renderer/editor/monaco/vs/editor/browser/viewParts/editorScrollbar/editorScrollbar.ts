...
import { ScrollableElementCreationOptions, ScrollableElementChangeOptions } from '../../../../base/browser/ui/scrollbar/scrollableElementOptions';
import { IOverviewRulerLayoutInfo, SmoothScrollableElement } from '../../../../base/browser/ui/scrollbar/scrollableElement';
import { INewScrollPosition } from '../../../common/editorCommon';
import { ViewPart, PartFingerprint, PartFingerprints } from '../../view/viewPart';
import { ViewContext } from '../../../common/view/viewContext';
import * as viewEvents from '../../../common/view/viewEvents';
import { RenderingContext, RestrictedRenderingContext } from '../../../common/view/renderingContext';
