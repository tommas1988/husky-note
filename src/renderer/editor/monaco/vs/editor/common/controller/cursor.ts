...
import { Selection, SelectionDirection, ISelection } from '../core/selection';
import * as editorCommon from '../editorCommon';
import { CursorColumns, CursorConfiguration, EditOperationResult, CursorContext, CursorState, RevealTarget, IColumnSelectData, ICursors, EditOperationType } from './cursorCommon';
import { DeleteOperations } from './cursorDeleteOperations';
import { TypeOperations } from './cursorTypeOperations';
import { RawContentChangedType } from '../model/textModelEvents';
...
import { ITextModel, IIdentifiedSingleEditOperation, TrackedRangeStickiness } from '../model';
