...
import { ICommand, IConfiguration, ScrollType } from '../editorCommon';
...
import { IAutoClosingPair } from '../modes/languageConfiguration';
...
import { TextModelResolvedOptions, ITextModel } from '../model';
