...
import { MirrorTextModel as BaseMirrorModel, IModelChangedEvent } from '../model/mirrorTextModel';
import { IInplaceReplaceSupportResult, ILink, ISuggestResult, ISuggestion, TextEdit } from '../modes';
import { computeLinks, ILinkComputerTarget } from '../modes/linkComputer';
...
import { IWordAtPosition, EndOfLineSequence } from '../model';
