...
import { InlineDecoration, ViewModelDecoration, ICoordinatesConverter, InlineDecorationType } from './viewModel';
import { IViewModelLinesCollection } from './splitLinesCollection';
