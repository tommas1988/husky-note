...
import { EditorAction, registerEditorAction, registerEditorContribution, ServicesAccessor } from '../../browser/editorExtensions';
...
import { TrackedRangeStickiness, IModelDeltaDecoration, OverviewRulerLane } from '../../common/model';
