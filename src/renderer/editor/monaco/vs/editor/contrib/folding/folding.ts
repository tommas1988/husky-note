...
import { RunOnceScheduler, Delayer, CancelablePromise, createCancelablePromise } from '../../../base/common/async';
import { KeyCode, KeyMod, KeyChord } from '../../../base/common/keyCodes';
import { IDisposable, dispose } from '../../../base/common/lifecycle';
import { TPromise } from '../../../base/common/winjs.base';
import { ScrollType, IEditorContribution } from '../../common/editorCommon';
import { ITextModel } from '../../common/model';
import { registerEditorAction, registerEditorContribution, ServicesAccessor, EditorAction, registerInstantiatedEditorAction } from '../../browser/editorExtensions';
import { ICodeEditor, IEditorMouseEvent, MouseTargetType } from '../../browser/editorBrowser';
import { FoldingModel, setCollapseStateAtLevel, CollapseMemento, setCollapseStateLevelsDown, setCollapseStateLevelsUp, setCollapseStateForMatchingLines, setCollapseStateForType } from './foldingModel';
...
import { IMarginData, IEmptyContentData } from '../../browser/controller/mouseTarget';
