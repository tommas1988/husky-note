...
import { registerEditorAction, ServicesAccessor, EditorAction, registerEditorContribution, IActionOptions } from '../../browser/editorExtensions';
...
import { ISingleEditOperation } from '../../common/model';
