...
import { Location, DefinitionProviderRegistry } from './..\..\common\modes';
import { ICodeEditor, IMouseTarget, MouseTargetType } from './..\..\browser\editorBrowser';
...
import { registerThemingParticipant } from './..\..\..\platform\theme\common\themeService';
import { editorActiveLinkForeground } from './..\..\..\platform\theme\common\colorRegistry';
import { EditorState, CodeEditorStateFlag } from './..\..\browser\core\editorState';
import { DefinitionAction, DefinitionActionConfig } from './goToDeclarationCommands';
import { ClickLinkGesture, ClickLinkMouseEvent, ClickLinkKeyboardEvent } from './clickLinkGesture';
import { IWordAtPosition, IModelDeltaDecoration } from './..\..\common\model';
