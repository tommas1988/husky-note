...
import { registerEditorAction, ServicesAccessor, EditorAction, registerEditorContribution } from '../../browser/editorExtensions';
import { IInplaceReplaceSupportResult } from '../../common/modes';
