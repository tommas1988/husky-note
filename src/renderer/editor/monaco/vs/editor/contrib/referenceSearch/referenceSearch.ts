...
import { registerEditorAction, ServicesAccessor, EditorAction, registerEditorContribution, registerDefaultLanguageCommand } from '../../browser/editorExtensions';
import { Location, ReferenceProviderRegistry } from '../../common/modes';
...
import { ICodeEditor, isCodeEditor } from '../../browser/editorBrowser';
