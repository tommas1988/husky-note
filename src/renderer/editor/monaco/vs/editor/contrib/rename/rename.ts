...
import { RawContextKey, IContextKey, IContextKeyService, ContextKeyExpr } from '../../../platform/contextkey/common/contextkey';
import { IProgressService } from '../../../platform/progress/common/progress';
import { registerEditorAction, registerEditorContribution, ServicesAccessor, EditorAction, EditorCommand, registerEditorCommand, registerDefaultLanguageCommand } from '../../browser/editorExtensions';
...
import { WorkspaceEdit, RenameProviderRegistry, RenameProvider, RenameLocation } from '../../common/modes';
