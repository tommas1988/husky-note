...
import { first2, createCancelablePromise, CancelablePromise } from '../../../base/common/async';
...
import { registerEditorContribution, EditorAction, IActionOptions, registerEditorAction, registerDefaultLanguageCommand } from '../../browser/editorExtensions';
import { DocumentHighlight, DocumentHighlightKind, DocumentHighlightProviderRegistry } from '../../common/modes';
...
import { CursorChangeReason, ICursorPositionChangedEvent } from '../../common/controller/cursorEvents';
...
import { ITextModel, TrackedRangeStickiness, OverviewRulerLane, IModelDeltaDecoration } from '../../common/model';
