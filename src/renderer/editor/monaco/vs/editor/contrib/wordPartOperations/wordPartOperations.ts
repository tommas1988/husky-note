...
import { WordNavigationType, WordPartOperations } from '../../common/controller/cursorWordOperations';
import { WordCharacterClassifier } from '../../common/controller/wordCharacterClassifier';
