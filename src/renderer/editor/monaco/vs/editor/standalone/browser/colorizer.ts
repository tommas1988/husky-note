...
import { ColorId, MetadataConsts, FontStyle, TokenizationRegistry, ITokenizationSupport } from '../../common/modes';
...
import { LineTokens, IViewLineTokens } from '../../common/core/lineTokens';
