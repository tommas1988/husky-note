...
import { registerEditorAction, registerEditorContribution, EditorAction, ServicesAccessor } from '../../../browser/editorExtensions';
import { ICodeEditor, ContentWidgetPositionPreference, IContentWidget, IContentWidgetPosition } from '../../../browser/editorBrowser';
import { IModeService } from '../../../common/services/modeService';
import { TokenizationRegistry, LanguageIdentifier, FontStyle, StandardTokenType, ITokenizationSupport, IState, TokenMetadata } from '../../../common/modes';
