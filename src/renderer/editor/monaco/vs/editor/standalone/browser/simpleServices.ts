...
import { IConfigurationService, IConfigurationChangeEvent, IConfigurationOverrides } from '../../../platform/configuration/common/configuration';
import { ICommandService, ICommand, ICommandEvent, ICommandHandler, CommandsRegistry } from '../../../platform/commands/common/commands';
...
import { IKeybindingEvent, KeybindingSource, IKeyboardEvent } from '../../../platform/keybinding/common/keybinding';
import { ContextKeyExpr, IContextKeyService } from '../../../platform/contextkey/common/contextkey';
import { IWorkspaceContextService, IWorkspace, IWorkspaceFolder, WorkspaceFolder } from '../../../platform/workspace/common/workspace';
import * as editorCommon from '../../common/editorCommon';
import { ICodeEditor, IDiffEditor, isCodeEditor } from '../../browser/editorBrowser';
...
import { IDisposable, IReference, ImmortalReference, combinedDisposable, toDisposable } from '../../../base/common/lifecycle';
import * as dom from '../../../base/browser/dom';
import { StandardKeyboardEvent } from '../../../base/browser/keyboardEvent';
import { KeybindingsRegistry, IKeybindingItem } from '../../../platform/keybinding/common/keybindingsRegistry';
...
import { ResolvedKeybinding, Keybinding, createKeybinding, SimpleKeybinding } from '../../../base/common/keyCodes';
...
import { INotificationService, INotification, INotificationHandle, NoOpNotification } from '../../../platform/notification/common/notification';
...
import { IBulkEditService, IBulkEditOptions, IBulkEditResult } from '../../browser/services/bulkEditService';
import { WorkspaceEdit, isResourceTextEdit, TextEdit } from '../../common/modes';
