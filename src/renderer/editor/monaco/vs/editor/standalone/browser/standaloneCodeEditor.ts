...
import { Disposable, IDisposable, combinedDisposable, toDisposable } from '../../../base/common/lifecycle';
...
import { IModelChangedEvent } from '../../common/editorCommon';
...
import { MenuId, MenuRegistry, IMenuItem } from '../../../platform/actions/common/actions';
